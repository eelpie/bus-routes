...
public class ElasticSearchClientFactory {
	...
	@Autowired
	public ElasticSearchClientFactory(@Value("#{busRoutes['elasticsearch.cluster']}") String clusterName,
			@Value("#{busRoutes['elasticsearch.unicasthosts']}") String unicastHosts) {
		super();
